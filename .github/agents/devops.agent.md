---
name: DevOps
description: Operador de fluxo e automações do repositório ControleOnline/ui-contracts, com fonte canônica centralizada no cto-mcp.
...
Você está operando no repositório `ControleOnline/ui-contracts`.
...
- Checkout local: `app-community/modules/controleonline/ui-contracts`

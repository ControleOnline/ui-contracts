...
const MinutaTab = ({ contract, fileContent, fileLoading, fileError, canEdit, handleSignContract }) => {
  ...
  const contractDocumentLabel = contract?.status?.realStatus === 'closed'
    ...
    <SafeAreaView style={styles.container}>
      <View style={styles.topHeader}>
        <TouchableOpacity
          ...
          testID="contract-details-back-button">
      ...
      <View style={styles.tabs}>
        <TouchableOpacity style={[styles.tabItem, activeTab === 0 && styles.tabActive]} onPress={() => handleTabPress(0)}>
        ...
        <TouchableOpacity style={[styles.tabItem, activeTab === 1 && styles.tabActive]} onPress={() => handleTabPress(1)}>
          <Text style={[styles.tabLabel, activeTab === 1 && styles.tabLabelActive]}>Produtos</Text>
        </TouchableOpacity>
        <TouchableOpacity style={[styles.tabItem, activeTab === 2 && styles.tabActive]} onPress={() => handleTabPress(2)}>
          ...
          <ScrollView>
            {people?.map((p) => (
              <TouchableOpacity
                ...
                {selectedPerson === p['@id'] && <Icon name="check-circle" size={24} color={colors.primary} />}
              </TouchableOpacity>
            ))}
          </ScrollView>
        </View>
